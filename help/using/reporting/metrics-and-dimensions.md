...
| **数据源** | 列表用于&#x200B;**在旅程中**（如体验平台、预订系统）扩充数据的数据源（数据源名称）。 |
...
| **移动应用程序名称** | 移动应用程序的名称 |
| **Platform** | 消息从中打开／查看／单击的设备的Platform。 |
| **[!UICONTROL Push platform]** | 打开推送通知的设备Platform，如iOS或Android。 |
| **收件人域** | 用于打开电子邮件的域。 |
| **跟踪URL** | 用户从消息中单击的URL。 |
| **跟踪URL类别** | 分配给跟踪URL的类别。 |
...
| 度量 | 定义 |
|--- |--- |
| **阻止列表** | 已声明电子邮件为垃圾邮件或垃圾邮件的收件人数。 |
| **块列表速率** | 与发送的消息相比，块列表上的消息总数。 |
