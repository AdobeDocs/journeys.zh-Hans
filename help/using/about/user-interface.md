...
在 **[!UICONTROL Data Sources]**、**[!UICONTROL Events]** 和 **[!UICONTROL Actions]** 列表中，使用&#x200B;**创建过滤器**，按创建日期和用户进行筛选。例如，您可以选择仅显示您在过去 30 天中创建的事件。
...
## 浏览 Data Platform 字段 {#friendly-names-display}
...
* 按下&#x200B;**[!UICONTROL Enter]**&#x200B;或单击窗格外部以关闭配置窗格。更改已保存。这等同于 **[!UICONTROL Ok]**&#x200B;按钮。
* 如果按 **[!UICONTROL Delete]**&#x200B;或 **Backspace** 键，则可以按 **[!UICONTROL Enter]** 以确认删除。

_在弹出窗口中：_

* 按 **Esc** 将其关闭（等同于&#x200B;**取消**&#x200B;按钮）。
* 按 **[!UICONTROL Enter]**&#x200B;保存或确认（等同于 **[!UICONTROL Ok]** 或 **[!UICONTROL Save]** 按钮）。
...
* 选择一个或多个活动后，按 **[!UICONTROL Delete]**&#x200B;或 **Backspace** 键以删除活动。然后，您可以在确认弹出窗口中按 **[!UICONTROL Enter]**&#x200B;确认。
