...
# 使用Campaign {#campaign-v7-v8-use-case}发送消息

此用例介绍使用Adobe Campaign集成发送电子邮件所需的所有步骤。

我们将首先在Campaign中创建事务型电子邮件模板。 然后，在Journey Orchestration中，我们将创建事件、操作并设计历程。

要了解有关Campaign集成的更多信息，请参阅以下页面：

* [创建Campaign操作](../action/working-with-adobe-campaign.md#using_adobe_campaign_v7_v8)
* [在历程中使用操作](../building-journeys/using-adobe-campaign-actions.md)。
